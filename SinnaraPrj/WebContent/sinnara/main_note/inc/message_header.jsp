<%@ page contentType="text/html; charset=EUC-KR"%>
		...
		<header id="header">
					...
					<div class="info">
						<strong class="user">팔강공주 님 &nbsp;
							<span class="member_nickname" member_id="supercjm" style="cursor: pointer;">
								<img src="/SinnaraPrj/sinnara/main_note/images/common/btn_seletor_pop.gif" alt="" class="img_sel" />
							</span> 
						</strong>
						...
						<a href="#" class="btn_img"><img
							src="/SinnaraPrj/sinnara/main_note/images/common/btn_top_logout.gif" alt="로그아웃"></a>
					</div>
				</div>
			</div>
			<div style="width: 990px; margin: 0 auto; overflow: hidden; position: relative">
				...
				<h1 style="margin-top: 25px;">
					<a href="/SinnaraPrj/sinnara/index.jsp"><img src="/SinnaraPrj/sinnara/main_note/images/common/logo3-dark.png" width="125"	height="30" alt="SINARA"></a>
				</h1>
				<div class="webtoon_logo" style="">
					<a href="/SinnaraPrj/sinnara/index.jsp"> 
						<span style="margin-left: 20px"><img src="/SinnaraPrj/sinnara/main_note/images/common/h2_webso_on.png" alt="웹소설" /></span>
					</a> 
					<img src="/SinnaraPrj/sinnara/main_note/images/common/img_h1bg.gif" alt=""	style="margin-left: 10px" /> 
				</div>
		...
		<div class="gb" style="width: 100%; background: url('/images/main/img_gnbbg.gif') repeat; height: 45px; position: relative; z-index: 6; top: 6px; margin-bottom: 7px;">
			<nav id="gnb">
				<ul>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb1.gif" alt="작품"></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb2.gif" alt="연재 작품"></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb3.gif" alt="프리미엄"></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb9_1.gif" alt="로맨스"></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb10.gif" alt="완결작품관" /></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb4.gif" alt="베스트"></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb5.gif" alt="커뮤니티"></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb7.gif" alt="아이템샵"></a></li>
					<li><a href="#"><img src="/SinnaraPrj/sinnara/main_note/images/common/nav_gnb8.gif" alt="고객센터"></a></li>
				</ul>
