...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9">	
			<form class="form-horizontal" name=form method=post action="UpdateProc.jsp" >
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" name="notice_subject" value="<%=dto.getNotice_subject()%>">
					</div>
				</div>
				...
				<div class="form-group" align="left">
					...
					<div class="col-sm-8">
						<textarea class="form-control" rows="10" name="notice_content">
						<%=dto.getNotice_content()%></textarea>
					</div>
				</div>
				...
				<div class="col-md-12" align="center">	
					<input class="btn btn-default btn-sm" type="submit" value="수정완료" onClick="check()">
